// content.js v2.15.0 — Challenge Funnel in a Box
...
(function () {
  ...
  if (window.__cfExtLoaded === "2.15.0") return;
  window.__cfExtLoaded = "2.15.0";
  ...
  window.addEventListener("message", (evt) => {
    ...
    if (t === "CF_PING") {
      window.postMessage({ source: "cf-ext", type: "CF_PONG", version: "2.15.0" }, "*");
    }
