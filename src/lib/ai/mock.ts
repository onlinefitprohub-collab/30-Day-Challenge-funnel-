  ...
  return {
    ...
    clientStories: [
      ...
      },
      {
        ...
        intro: `Meet ${isFemaleAudience ? "Jenny" : "Tom"}, who hadn't exercised consistently in five years before ${programmeName} gave ${isFemaleAudience ? "her" : "him"} a reason to start again.`,
