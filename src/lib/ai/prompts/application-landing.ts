...
IF NO TESTIMONIALS PROVIDED IN CONTEXT: Generate 3 realistic testimonials that match the target audience. Create quotes that reference specific struggles mentioned in the wizard (biggestStruggle, objections) and resolutions that map to the programme's inclusions. Ensure names match audience gender.
