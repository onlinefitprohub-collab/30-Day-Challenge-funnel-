    ...
    <div className="space-y-4">
      <div className="rounded-xl border border-violet-200 bg-violet-50 p-4 mb-3">
        <p className="text-sm text-violet-900">
          <span className="font-semibold">How to use:</span> This 3,000–5,000 word sales letter can be used as: (1) A long-form landing page (paste into GHL/your page builder), (2) A multi-part email sequence (split into 5–7 emails), or (3) A PDF download to send cold traffic. Copy and paste each section. Personalise with your name, links, and offer details.
        </p>
      </div>
