...
export function EmptyState() {
  return (
    <div className="space-y-6">
      {/* Hero empty card */}
      <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/[0.10] bg-[#111113] px-8 py-16 text-center">
        ...
        <p className="mt-2 max-w-xs text-zinc-400 text-sm leading-relaxed">
        ...
        <Link href="/projects/new" className="mt-7">
          <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white font-semibold border-0 shadow-sm">
      ...
      <div>
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          {HOW_IT_WORKS.map(({ icon: Icon, title, body }, i) => (
            <div key={i} className="rounded-xl border border-white/[0.07] bg-[#18181b] p-4">
